<div className="max-w-4xl mx-auto py-12 px-6">
  ...
  <p className="text-lg leading-relaxed mb-6">
    ...
    a dream to share a piece of their heritage with their new community.
  </p>
  <p className="text-lg leading-relaxed mb-6">
  ...
  <p className="text-lg leading-relaxed mb-6">
    ...
    our signature pizza or trying one of our house-made pasta dishes,
    you&apos;re not just getting a meal - you&apos;re becoming part of our
    family legacy.
  </p>
  <p className="text-lg leading-relaxed mb-6">
